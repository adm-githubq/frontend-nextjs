...
const ServicePage = async ({ params }: { params: { slug: string } }) => {
  ...
  const PageData: Service = {
    id: ServicePageData.data.id,
    heading: ServicePageData.data.attributes.Heading,
    subheading: ServicePageData.data.attributes.HeadingBodyCopy,
    bulletPointsSectionTitle:
      ServicePageData.data.attributes.BulletPointsSectionTitle,
    bulletPoints: ServicePageData.data.attributes.BulletPoints,
    headingImage: ServicePageData.data.attributes.HeadingImage.data.attributes
      .formats
      ? ServicePageData.data.attributes.HeadingImage.data.attributes.formats
          .large.url
      : ServicePageData.data.attributes.HeadingImage.data.attributes.url,
    otherServicesSectionTitle:
      ServicePageData.data.attributes.OtherServicesSectionTitle
  }
